...
import { isHighlight } from '../../sidebar/helpers/annotation-metadata';
import { getElementHeightWithMargins } from '../../sidebar/util/dom';
import {
  calculateVisibleThreads,
  THREAD_DIMENSION_DEFAULTS,
} from '../../sidebar/helpers/visible-threads';
